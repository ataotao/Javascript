 ...
 ***************************************************************************/
console.log('-----------版本一------------------');
console.log('-----------JS里对观察者模式的实现是通过回调来实现的，我们来先定义一个pubsub对象，其内部包含了3个方法：订阅、退订、发布。------------------');
(function () {
...
console.log('-----------版本二------------------');
console.log('-----------我们也可以利用原型的特性实现一个观察者模式，代码如下：------------------');
(function () {
...
console.log('-----------版本三------------------');
console.log('-----------如果想让多个对象都具有观察者发布订阅的功能，我们可以定义一个通用的函数，然后将该函数的功能应用到需要观察者功能的对象上，代码如下：------------------');
(function () {
