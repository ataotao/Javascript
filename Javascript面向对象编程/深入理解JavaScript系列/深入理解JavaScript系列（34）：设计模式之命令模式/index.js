 ...
 ***************************************************************************/
console.log('-----------我们来通过车辆购买程序来展示这个模式，首先定义车辆购买的具体操作类：------------------');
...
(function () {
    ...
    $(function () {
        ...
        console.log(CarManager.requestInfo('car', 1));
...
console.log('--------------------根据这样的需求，我们可以这样啦实现CarManager.execute方法：--------------------');
/**
...
(function () {
    ...
    var a = CarManager.execute({ request: 'arrangeViewing', model: 'Ferrari', carID: '145523' });
    var b = CarManager.execute({ request: 'requestInfo', model: 'Ford Mondeo', carID: '543434' });
    var c = CarManager.execute({ request: 'requestInfo', model: 'Ford Escort', carID: '543434' });
    var d = CarManager.execute({ request: 'buyVehicle', model: 'Ford Escort', carID: '543434' });
    console.log(a);
    console.log(b);
    console.log(c);
    console.log(d);
